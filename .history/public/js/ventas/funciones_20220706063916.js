            ...
            if (id_venta != 0) {
                ...
                data1.venta.forEach(c => {
                    ...
                    templateventa += `
                        ...
                        <h6 style="font-size:12px;" class="fecha text-dark" style="margin-top:-5px;">${c.fecha_entrega}</h6>
                        <h6 style="font-size:12px;" class="cliente" style="margin-top:-5px;">${c.nombre_cliente} / ${c.nombre_tienda}</h6>
