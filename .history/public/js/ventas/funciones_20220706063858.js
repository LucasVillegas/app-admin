        ...
        if (e.target.matches('.form-open-modal')) {
            ...
            if (id_venta != 0) {
                ...
                data1.venta.forEach(c => {
                    ...
                    templateventa += `
                        <h5 class="estado"><span class="badge ${c.estado_venta == 1 ? "text-warning" : "text-success"}">${c.estado_venta == 1 ? "Pendiente de facturación" : "Facutación aprobada"}</span></h5>
                        <h6 style="font-size:12px;" class="factura text-dark">Factura ID ${c.id}</h6>
                        <h6 style="font-size:12px;" class="fecha text-dark" style="margin-top:-10px;">${c.fecha_entrega}</h6>
                        <h6 style="font-size:12px;" class="cliente" style="margin-top:-10px;">${c.nombre_cliente} / ${c.nombre_tienda}</h6>
                        <h6 class="total">$ ${formatNum(c.total_venta)}</h6>
                        `;
                });
