        ...
        if (e.target.matches('.form-open-modal')) {
            ...
            if (id_venta != 0) {
                ...
                data1.venta.forEach(c => {
                    ...
                    templateventa += `
                        <h5  style="font-weight:bold;" class="estado"><span class="badge ${c.estado_venta == 1 ? "text-danger" : "text-success"}">${c.estado_venta == 1 ? "Pendiente de facturación" : "Facutación aprobada"}</span></h5>
