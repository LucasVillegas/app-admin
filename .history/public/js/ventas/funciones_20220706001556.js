...
export async function listar_ventas(buscar) {
    ...
    data.forEach((value) => {
        ...
        if (estado_venta == 1) {
            estado = document
                .getElementById("movimiento")
                .content.querySelector(".estado").innerHTML = '<span class="badge text-danger">Pendiente</span>';
        } else {
            estado = document
                .getElementById("movimiento")
                .content.querySelector(".estado").innerHTML = '<span class="badge text-success">Realizada</span>';
        }
        /* document
            .getElementById("movimiento")
