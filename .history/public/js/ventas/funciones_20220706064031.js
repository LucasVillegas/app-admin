            ...
            if (id_venta != 0) {
                ...
                data1.venta.forEach(c => {
                    ...
                    templateventa += `
                        ...
                        <h6 style="font-size:12px;" class="fecha text-dark">${c.fecha_entrega}</h6>
                        <h6 style="font-size:12px;margin-bottom:20px;" class="cliente">${c.nombre_cliente} / ${c.nombre_tienda}</h6>
