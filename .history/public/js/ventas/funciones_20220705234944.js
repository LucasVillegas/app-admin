...
export async function listar_ventas(buscar) {
    ...
    data.forEach((value) => {
        ...
        document
            ...
            .content.querySelector(".fecha").textContent = dia;
        document
            .getElementById("movimiento")
            .content.querySelector(".factura").textContent = nombre_ruta + " / " + nombre;
        document
            .getElementById("movimiento")
            .content.querySelector(".tienda").textContent = dia_id;
        document
            .getElementById("movimiento")
            .content.querySelector(".total").textContent = dia_id;
        //
