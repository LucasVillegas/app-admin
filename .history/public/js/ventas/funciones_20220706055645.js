    ...
    d.addEventListener("submit", async (e) => {
        ...
        if (e.target.matches('.form-open-modal')) {
            ...
            if (id_venta != 0) {
                ...
                //d.getElementById("obs").textContent = data.observaciones;
                console.log("🚀 ~ file: funciones.js ~ line 39 ~ d.addEventListener ~ data.observaciones", data.observaciones.value)
                data.forEach((value) => {
