...
export async function listar_productos(buscar) {
    ...
    data.forEach((value) => {
        ...
        /* image += `<img src='../../public/img productos/${foto_producto}' alt='Opss..!' width='50px' height='50px'>`;
        const image = document.createElement('img');
        image.src = '../../public/img/productos/' + foto_producto; */
        document
        ...
        document
            .getElementById("movimiento")
            .content.querySelector(".img").innerHTML = '<img src="../../img/productos/' + foto_producto + '" alt="Opss..!" width="50px" height="50px">';
