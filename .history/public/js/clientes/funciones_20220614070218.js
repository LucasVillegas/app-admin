...
export function requests() {
    d.addEventListener("click", async (e) => {
        ...
        if (e.target.matches('.btn-add-cliente') || e.target.matches('.btn-add-cliente *')) {
            //d.getElementById("Modal-Edit-Cliente").modal('show');
            var myModal = new bootstrap.Modal(document.getElementById('Modal-Edit-Cliente'), options);
            myModal.show()
            /* VanillaToasts.create({
                title: 'Message Title',
                text: 'Notification text',
                type: 'success',
                icon: '../public/img/success.png'
            }); */
        }
    });
}
