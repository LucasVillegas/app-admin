...
export function requests() {
    d.addEventListener("click", async (e) => {
        ...
        if (e.target.matches('#btn-edit') || e.target.matches('#btn-edit *')) {
            ...
            let id_cliente = d.getElementById("id_cliente").value;
        ...
        template_lista_clinetes += `
            <div class="card" style="height: 60px;border-radius:5px;margin-top:-25px">
                <div class="card-body p-2">
                    <div class="row">
                        <div class="col-2">
                            <button type="submit" class="btn btn-outline-warning btn-sm" id="btn-edit" class="btn-edit" data-bs-toggle="modal" data-bs-target="#Modal-Edit-Cliente"><i class="bi bi-pencil-square"></i></button>
                        </div>
                        <input type="hidden" class="id_cliente" id="id_cliente" value="${c.cliente_id}">
                        <div class="col-10">
