        ...
        template_lista_clinetes += `
            ...
            <div class="card" style="height: 60px;border-radius:5px;margin-top:-25px">
                <div class="card-body p-2">
                    <div class="row">
                        <div class="col-2">
                            <button type="button" class="btn btn-outline-warning btn-sm"><i class="bi bi-pencil-square"></i></button>
                        </div>
                        <input type="hidden" class="id_cliente" value="${c.cliente_id}">
                        <div class="col-10">
                            <i class="bi bi-circle bi-1x"></i> <span class="text-dark">${c.nombre_cliente.toLowerCase()}</span>
                            <br/>
                            <i class="bi bi-circle"></i> <span class="text-dark">${c.telefono_cliente.toLowerCase()}</span>
