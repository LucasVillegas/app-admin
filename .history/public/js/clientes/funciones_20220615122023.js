...
export function requests() {
    d.addEventListener("click", async (e) => {
        ...
        if (e.target.matches('#btn-edit') || e.target.matches('.btn-add-cliente *')) {
        ...
        template_lista_clinetes += `
            <div class="card" style="height: 60px;border-radius:5px;margin-top:-25px">
                <div class="card-body p-2">
                    <div class="row">
                        <div class="col-2">
                            <button type="button" class="btn btn-outline-warning btn-sm" id="btn-edit" class="btn-edit" data-bs-toggle="modal" data-bs-target="#Modal-Edit-Cliente"><i class="bi bi-pencil-square"></i></button>
                        </div>
