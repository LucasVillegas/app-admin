...
const btn_edit_cliente = d.getElementById('btn-edit');
console.log(btn_edit_cliente);
export function requests() {

    if (btn_edit_cliente) {
        btn_edit_cliente.addEventListener("click", edit_cliente());
    }
...
export async function listar_clientes(buscar) {
    ...
    let tbody = document.getElementById("lista-general-clientes");
    tbody.innerHTML = "";
    data.forEach((value) => {
        let {
            nombre_cliente,
        ...
        document
            ...
            .content.querySelector(".nombre-cliente").textContent = nombre_cliente;
        document
            .getElementById("movimiento")
            .content.querySelector(".telefono-cliente").textContent = telefono_cliente;
        document
            .getElementById("movimiento")
            .content.querySelector(".id_cliente").value = cliente_id;
        /*  document
            .getElementById("movimiento")
            .content.querySelector(".fecha").textContent = Fecha;
        document
            .getElementById("movimiento")
            .content.querySelector(".docref").textContent = DocRef;
        document
            .getElementById("movimiento")
            .content.querySelector(".tipo").textContent = Tipo;
        document
            .getElementById("movimiento")
            .content.querySelector(".cantidad").textContent = Cantidad;
        document
            .getElementById("movimiento")
            .content.querySelector(".valor").textContent = Valor; */
        ...
        template_lista_clinetes += `
            <div class="card" style="height: 60px;border-radius:5px;margin-top:-25px">
                <div class="card-body p-2">
                    <div class="row">
                        <div class="col-2">
                            <button type="button" class="btn btn-outline-warning btn-sm" id="btn-edit" class="btn-edit" ><i class="bi bi-pencil-square"></i>
...
export async function edit_cliente() {
    //if (e.target.matches('.btn-edit') || e.target.matches('.btn-edit *')) { }
    myModal.show();
    /*  let padre = e.target.parentElement.parentElement;
     let id_cliente = padre.querySelector(".id_cliente").value; */
