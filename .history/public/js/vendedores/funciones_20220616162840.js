...
export async function listar_vendedores(buscar) {
    ...
    data.forEach((value) => {
        ...
        document
            ...
            .content.querySelector(".nombre-cliente").textContent = nombre;
        document
            .getElementById("movimiento")
            .content.querySelector(".telefono-cliente").textContent = telefono;
        document
            .getElementById("movimiento")
            .content.querySelector(".id_cliente").value = persona_id;
