            ...
            if (id_vendedor != 0) {
                ...
                data.forEach((value) => {
                    ...
                    if (!data.length) {
                        ...
                        d.getElementById('id').value = users_id;
                        d.getElementById("usuario").value = identificacion;
                        d.getElementById('correo').value = nombre;
                        d.getElementById('password').value = apellido;
                        d.getElementById('password_confirmation').value = telefono;
                    }
                });
            } else {
                Toast.fire({
