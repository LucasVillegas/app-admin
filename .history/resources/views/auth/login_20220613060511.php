            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div id="alertas-usuario" style="display: none">
                            <div class="alert alert-danger alert-dismissible" role="alert">
                                <div class="d-flex">
                                    <div>
                                        <h4 class="alert-title">Error..</h4>
                                        <div class="text-muted">Por favor, introduzca su nombre de usuario.
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="alertas-clave" style="display: none">
                            <div class="alert alert-danger bg-danger text-light border-0 alert-dismissible fade show"
                                role="alert">¡Por favor, introduzca su contraseña!
                            ...
                            <div class="alert alert-danger alert-dismissible" role="alert">
                                <div class="d-flex">
                                    <div>
                                        <h4 class="alert-title">Error...</h4>
                                        <div class="text-muted">¡Por favor, introduzca su contraseña!
                                        </div>
                                    </div>
                                </div>
                                <a class="btn-close" data-bs-dismiss="alert" aria-label="close"></a>
                        ...
                        <div id="alertas-general" style="display: none">
                            <div class="alert alert-danger alert-dismissible" role="alert">
                                <div class="d-flex">
                                    <div>
                                ...
                                <form class="row g-3 needs-validation" novalidate>
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100 btn-login" type="submit">
                                            Acceso <svg xmlns="http://www.w3.org/2000/svg"
