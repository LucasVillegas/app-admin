...
<template id="movimiento">
    ...
    <div class="row">
        <div class="col-10">
            ...
            <!--  <h6 class="text-dark descripcion-unidad" style="font-size:12px;margin-top:-8px;">nombre_categoria</h6> -->
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <form id="form-bloq">
                            <button type="submit" class="dropdown-item btn text-info btn-sm" class="btn-edit"><i
                                ...
                                <input type="hidden" class="id_categorias" id="id_bloq">
                            </button>
                        </form>
                        <form id="form-active">
