...
<template id="movimiento">
    ...
    <div class="row">
        <div class="col-10">
            <h6 class="nombre-cliente" style="font-size:13px;">nombre_cliente</h6>
            <h6 class="text-dark telefono-cliente" style="font-size:12px;margin-top:-8px;">telefono_cliente</h6>
