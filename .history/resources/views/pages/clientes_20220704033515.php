...
<template id="movimiento">
    ...
    <div class="row">
        <div class="col-10">
            <h6 class="nombre-vendedor" style="font-size:13px;">nombre_cliente</h6>
            <h6 class="text-dark telefono-vendedor" style="font-size:12px;margin-top:-8px;">telefono_cliente</h6>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <form class="form-edit-user">
                            <button type="submit" class="dropdown-item btn text-warning btn-sm" class="btn-edit"><i
                                    class="bi bi-person-lines-fill"></i> Editar Usuario
                                <input type="hidden" class="id_vendedores">
                            </button>
                        </form>
                        <form id="form-bloq">
...
<script src="<?php echo SERVER_SCRIPT_CLIENTES; ?>index.js" type="module"></script>