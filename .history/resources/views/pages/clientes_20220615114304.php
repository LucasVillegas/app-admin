<div class="pagetitle">
    <div class="input-group mb-5">
        ...
        <input type="text" name="buscar" id="buscar" placeholder="Buscar Cliente" class="form-control"
            autocomplete="off">
        <button type="submit" class="btn btn-success btn-add-cliente"><i class="bi bi-person-plus"></i></button>

        <a href="tel:3017925954"
            onClick="return(navigator.userAgent.match(/ Android | iPhone | movile /i)) != null;">llamar</a>
    </div>
</div>
<!-- End Page Title -->
