            ...
            <div class="d-flex justify-content-end">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <form class="form-edit">
                            <button type="submit" class="btn text-info btn-sm" class="btn-edit"><i
                                    class="bi bi-pencil-square"></i> Bloquear
                                <input type="hidden" class="id_producto">
                            </button>
                        </form>
                        <form class="form-edit">
                            <button type="submit" class="btn text-danger btn-sm" class="btn-edit"><i
                                    class="bi bi-pencil-square"></i> Editar
                                <input type="hidden" class="id_producto">
                            </button>
                        </form>
