...
<template id="movimiento">
    <div class="row">
        <div class="col-10">
            <h6 class="nombre-dia" style="font-size:13px;">dia</h6>
            <h6 class="text-dark nombre-ruta" style="font-size:12px;margin-top:-8px;">nombre_ruta</h6>
            <h6 class="text-dark nombre-vendedor" style="font-size:12px;margin-top:-8px;">nombre_vendedor</h6>
