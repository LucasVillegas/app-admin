...
<template id="movimiento">
    <div class="row">
        ...
        <div class="col-10">
            ...
            <h6 class="text-dark nombre-unidad" style="font-size:12px;margin-top:-10px;">codigo . p.nombre_unidad</h6>
            <h6 class="text-dark precio" style="font-size:12px;margin-top:-10px;">codigo . p.nombre_unidad</h6>
        </div>
    </div>
    <hr class="my-1">
    <!--     <div class="row">
