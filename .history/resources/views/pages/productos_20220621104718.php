...
<template id="movimiento">
    <div class="row">
        ...
        <div class="col-8">
            <h5 class="name-product">nombre_producto</h5>
            <!-- <h6 class="text-dark cod-unid">codigo . p.nombre_unidad</h6>
            <h5 class="text-dark price">$ precio</h5> -->
        </div>
        <div class="d-flex justify-content-center">
            ...
            <div class="col-6 mt-2">
                <button type="submit" style="border: 1px solid #000000 !important; width: 150px; height: 25px"
                    class="btn btn-sm btn-insert">AÑADIR</button>
            </div>
        </div>
    </div>
    <hr>
