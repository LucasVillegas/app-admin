...
<template id="movimiento">
    <div class="row">
        <div class="col-6">
            <h6 class="fecha" style="font-size:13px;"><b>dia</b></h6>
            <h6 class="text-muted factura" style="font-size:12px;margin-top:-8px;">factura</h6>
            <h6 class="cliente" style="margin-top:-8px;">cliente</h6>
            <h6 class="tienda" style="margin-top:-8px;">cliente</h6>
            <h6 class="total" style="margin-top:-8px;">cliente</h6>
        </div>
