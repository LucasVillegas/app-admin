...
<template id="movimiento">
    <div class="row">
        ...
        <div class="col-10">
            <h6 class="nombre-producto" style="font-size:13px;marging-top:-10px;">nombre_producto</h6>
            <h6 class="text-dark nombre-unidad" style="font-size:12px">codigo . p.nombre_unidad</h6>
            <h6 class="text-dark precio" style="font-size:12px">codigo . p.nombre_unidad</h6>
        </div>
    </div>
    <hr class="my-1">
    <!--     <div class="row">
