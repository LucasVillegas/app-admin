        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="acciones" class="d-flex justify-content-center" style="display: none">
                    <button type="button" class="btn btn-warning btn-sm btn-bloq text-white mr-5"><i
                            class="bi bi-slash-square"></i> Bloquear</button>
                    <button type="button" class="btn btn-danger btn-sm btn-delete mr-5"><i class="bi bi-trash"></i>
                        Eliminar</button>
                </div>
            </div>
