        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <div id="acciones" style="display: none">
                    <button type="button" class="btn btn-primary btn-sm btn-save"><i class="bi bi-slash-square"></i>
                        Bloquear</button>
                    <button type="button" class="btn btn-danger btn-sm btn-save"><i class="bi bi-save"></i>
                        Eliminar</button>
                </div>
