...
<template id="detalle-producto">
    <div class="row">
        <div class="col-12">
            ...
            <h6 class="precio text-dark" style="margin-top:-5px;font-size:12px;">$precio/nombre_unidad</h6>
            <h6 class="cantidad text-center" style="margin-top:-15px;font-size:12px;">Xcantidad</h6>
            <h6 class="total-producto text-right" style="margin-top:-8px;font-size:12px;">$precio * cantidad
            </h6>
            <hr class="my-1">
        </div>
    </div>
