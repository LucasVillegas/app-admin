        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="acciones" class="d-flex justify-content-center" style="display: none">
                    <button type="button" id="btn-activ" class="btn btn-warning btn-sm btn-bloq text-white"><i
                            class="bi bi-slash-square"></i> Bloquear</button>

                    <button type="button" id="btn-activ" class="btn btn-dark btn-sm btn-activ text-white"
