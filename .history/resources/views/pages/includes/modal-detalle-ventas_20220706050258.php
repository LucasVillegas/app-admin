...
<template id="detalle-producto">
    <div class="row">
        <div class="col-12">
            ...
            <h6 class="precio text-dark" style="margin-top:-10px;">$precio/nombre_unidad</h6>
            <h6 class="cantidad text-center" style="margin-top:-20px;">Xcantidad</h6>
            <h5 class="total-producto text-right" style="margin-top:-25px;">$ v.precio * v.cantidad
            </h5>
            <hr class="my-1">
        </div>
    </div>
