...
<div class="modal fade" id="Modal-Edit-Rutas" tabindex="-1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST">
                    ...
                    <div class="row mb-2">
                        <label for="inputText" class="col-sm-2 col-form-label">Nombre Ruta<span
                    ...
                    <div class="row mb-2">
                        <label for="inputText" class="col-sm-2 col-form-label">Vendedor<span
                                class="badge badge-pill text-danger">*</span></label>
                        <div class="col-sm-10">
                            <select name="vendedor" id="vendedor" class="form-control" style="width:100%"></select>
                        </div>
                    </div>
                </form>
            </div>
