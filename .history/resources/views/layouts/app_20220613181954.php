...
<head>
    ...
    <!-- Alertas -->
    <script src="<?php echo SERVERVENDOR; ?>VanillaToasts/vanillatoasts.js"></script>
    <link href="<?php echo SERVERVENDOR; ?>simple-datatables/vanillatoasts.css" rel="stylesheet">
...
<body style="background-color:#ffffff !important">
    ...
    <!-- ======= Header ======= -->
    <?php require_once "./resources/views/layouts/partials/header.php" ?>
    <!-- End Header -->

    <!-- ======= Sidebar ======= -->
    <?php require_once "./resources/views/layouts/partials/sidebar.php" ?>
    <!-- End Sidebar-->
