...
class Producto extends conexion
{
    ...
    {
        $sql = conexion::conectar()->prepare("INSERT INTO productos (codigo_producto,nombre_producto,unidad_id,cantidad,precio_compra,porcentaje,
        precio_porcentaje,precio,estado_producto,fecha_creacion)
        VALUES(:codigo_producto,:nombre_producto,:unidad_id,:cantidad,:precio_compra,:porcentaje,:precio_porcentaje,:precio,:estado_producto,:fecha_creacion)");
    ...
    {
        $sql = conexion::conectar()->prepare("SELECT *, productos.id as producto_id FROM productos INNER JOIN unidades On productos.unidad_id=unidades.id WHERE productos.id=:Id");
    ...
    {
        $sql = conexion::conectar()->prepare("UPDATE productos SET nombre_producto=:Nombre,unidad_id=:Unidad,precio_compra=:Precio_Compra,porcentaje=:Porcentaje,
        precio_porcentaje=:Precio_Porcentaje,precio=:Precio WHERE id=:Id");
