...
class Producto extends conexion
{
    ...
    public function addproducto($datos)
    {
        ...
        VALUES(:codigo_producto,:nombre_producto,:unidad_id,:cantidad,:precio_compra,:porcentaje,:precio_porcentaje,:precio,:estado_producto,:foto_producto,:fecha_creacion)");
