...
class VendedorController
{
    ...
    public function agregar_vendedor()
    {
        ...
        $correo = $this->helpers->limpiar_cadena($_POST['email']);
    ...
    public function listar_vendedor()
    {
        if ($this->helpers->limpiar_cadena(isset($_POST['dato'])) && $this->helpers->limpiar_cadena(!empty($_POST['dato']))) {
            ...
            $sql = $this->conexion->ejecutar_consulta_simple("SELECT *,p.id AS persona_id,u.id AS users_id FROM personas p INNER JOIN usuarios u ON u.persona_id=p.id WHERE u.tipo_usuario='Vendedor' AND p.nombre LIKE '%$search%' ");
            $resultado = $sql->fetchAll();
            $json = array();
            foreach ($resultado as $row) {
                $json[] = array(
            ...
            $sql = $this->conexion->ejecutar_consulta_simple("SELECT *,p.id AS persona_id,u.id AS users_id FROM personas p INNER JOIN usuarios u ON u.persona_id=p.id WHERE u.tipo_usuario='Vendedor' LIMIT 15");
            $resultado = $sql->fetchAll();
            $json = array();
            foreach ($resultado as $row) {
                $json[] = array(
        ...
        /* $listar = $this->vendedor->list_seller();
    ...
    {
        $id = $this->helpers->limpiar_cadena($_POST['Codseller']);
        $datoslist = [
            'Id' => $id
        ];
    ...
    public function actualizar_datos_vendedor()
    {
        ...
        $identificacion = $this->helpers->limpiar_cadena($_POST['identificacion-update']);
        $nombre = $this->helpers->limpiar_cadena($_POST['nombre-update']);
        $apellidos = $this->helpers->limpiar_cadena($_POST['apellido-update']);
        $telefono = $this->helpers->limpiar_cadena($_POST['telefono-update']);
        $datos = [
            "Identificacion" => $identificacion,
            "Nombre" => $nombre,
            "Apellido" =>  $apellidos,
    ...
    {
        $id = $this->helpers->limpiar_cadena($_POST['Coduser']);
        $data = [
            'Id' => $id
        ];
    ...
    {
        $id = $this->helpers->limpiar_cadena($_POST['id-user']);
        $usuario = $this->helpers->limpiar_cadena($_POST['usuario-update']);
        $correo = $this->helpers->limpiar_cadena($_POST['email-update']);
        $clave1 = $this->helpers->limpiar_cadena($_POST['password-update']);
        $clave = $this->helpers->encryption($clave1);
    ...
    {
        $id = $this->helpers->limpiar_cadena($_POST['Codadminbloq']);
        $datoseli = [
            'Id' => $id,
        ];
    ...
    {
        $id = $this->helpers->limpiar_cadena($_POST['Codadminactiv']);
        $datoseli = [
            'Id' => $id,
        ];
    ...
    {
        $id = $this->helpers->limpiar_cadena($_POST['Codadmindelet']);
        $datoseli = [
            'Id' => $id,
        ];
