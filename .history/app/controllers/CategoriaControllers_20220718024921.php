...
class CategoriaControllers
{
    ...
    public function agregar_categoria()
    {
        ...
        $ruta_carpeta1         = "C:/laragon/www/app-movil/public/img/categorias1/";
        $r                    = rand(0, 1000);
        $fecha                = date("his");
        ...
        if (move_uploaded_file($_FILES['file']['tmp_name'], $ruta_guardar_archivo) && move_uploaded_file($_FILES['file']['tmp_name'], $ruta_guardar_archivo1)) {;
