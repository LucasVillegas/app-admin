    ...
    public function agregar_categoria()
    {
        ...
        if (move_uploaded_file($_FILES['file']['tmp_name'], $ruta_guardar_archivo)) {
            ...
            if ($consulta->rowCount() >= 1) {
                ...
                $sql = $this->conexion->ejecutar_consulta_simple("INSERT INTO categorias(nombre_categoria,foto_categoria,fecha_categoria,estado_categoria) VALUES('$categoria','$fecha',1)");
                $respuesta = 0;
                if ($sql->rowCount() >= 1) {
                    $respuesta++;
                }
