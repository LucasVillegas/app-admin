...
class CategoriaControllers
{
    ...
    public function agregar_categoria()
    {
        ...
        if ($consulta->rowCount() >= 1) {
            ...
            $sql = $this->conexion->ejecutar_consulta_simple("INSERT INTO categorias(nombre_categoria,fecha_categoria,estado_categoria) VALUES('$categoria',,1)");
            $respuesta = 0;
            if ($sql->rowCount() >= 1) {
                $respuesta++;
            }
