...
class ProductosControllers
{
    ...
    {
        $descripcion = $helpers->limpiar_cadena($_POST['descripcion']);
        $unidad = $helpers->limpiar_cadena($_POST['unidad']);
        $nuevoPrecioCompra = $helpers->limpiar_cadena($_POST['nuevoPrecioCompra']);
        $nuevoPrecioPorcentaje = $helpers->limpiar_cadena($_POST['nuevoPrecioPorcentaje']);
        $preciototal = $helpers->limpiar_cadena($_POST['preciototal']);
        $porcentaje = $helpers->limpiar_cadena($_POST['porcentaje']);
        $codigo = $helpers->limpiar_cadena($_POST['codigo']);
        $cantidad = $helpers->limpiar_cadena($_POST['cantidad']);
        $datos = [
        ...
        $guardar = $modelo->addproducto($datos);
        $respuesta = 0;
