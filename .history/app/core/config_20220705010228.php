...
const SERVER_SCRIPT_CATEGORIAS = SERVERURL . "public/js/categorias/";
const SERVER_SCRIPT_UNIDADES = SERVERURL . "public/js/unidades/";
const SERVER_SCRIPT_PRODUCTOS = SERVERURL . "public/js/productos/";
const SERVER_SCRIPT_RUTAS = SERVERURL . "public/js/rutas/";
const SERVER_SCRIPT_DIAS_RUTAS = SERVERURL . "public/js/rutas/";
